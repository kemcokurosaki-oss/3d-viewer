...
- ライブラリ: `DocLib8`
- フォルダ: `★3DGS(動画から作成した3D写真)`
- 配下の構成: **社内で相談中**（工事番号／機械名の2階層で分ける方針）
- 既存ファイル名の例: `2814DF①.splat`、`2810FL-1.splat`、`2810PC-3.splat`
...
- SharePoint に同じファイルがあるなら Supabase Storage 側は削除して統一
- 無いものだけ SharePoint にアップし直す
